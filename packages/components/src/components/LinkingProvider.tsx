 ...
 *
 * @chromaticTest/components aims to be reusable. Therefore the links
...
export interface ChromaticTestLinkProps {
  community?: string;
  namespace?: string;
  package?: string;
  team?: string;
...
// If any new properties were added to ChromaticTestLinkProps, add a
...
export const chromaticTestLinkProps: ChromaticTestLinkProps = {
  community: "",
  namespace: "",
  package: "",
  team: "",
